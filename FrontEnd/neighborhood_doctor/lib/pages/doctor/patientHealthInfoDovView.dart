...
class PatientHealthInfoDoctor extends StatefulWidget {
  const PatientHealthInfoDoctor({Key? key, required this.title, required this.jwt}) : super(key: key);
  final String title;
  final String jwt;
  //PatientHealthInfoDoctor(this.title, this.jwt);
  @override
  State<StatefulWidget> createState() {
    return PatientHealthInfoDoctorState(this.jwt);
  }
}
...
class PatientHealthInfoDoctorState extends State<PatientHealthInfoDoctor> {
  ...
  final String jwt;
  PatientHealthInfoDoctorState(this.jwt);
  ...
  Future<List<Map<String, dynamic>>> allPatients(String jwt, BuildContext context) async {
    patients.clear();
    Uri urlViewPatients = Uri.parse("https://neighborhood-doctors-backend.herokuapp.com/patient/retrieveAllPatients");
