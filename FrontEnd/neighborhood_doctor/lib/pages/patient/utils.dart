...
import 'package:neighborhood_doctors/Model/AppointmentModel.dart';
import 'dart:convert';
...
Event appointmentToEvent(AppointmentModel model) {
  String start = model.timeStart;
  String end = model.timeEnd;
  Event event = Event("Appointment: $start: 30 Min", model);
  return event;
}
